...
var ShooterGame = function (bool) {
    ...
    imageManager.load('player', "jade.png")    //fill in the images for the file
    imageManager.load('enemy', 'rona2.png')
    imageManager.load('hannity','hannity.png')
    imageManager.load('carole', 'carole.png')
    ...
    var Enemy = function (speed) {
        ...
        this.update = function () {
            this.gameObject.add(speed);
            if(enemyTimeThreshold >= 400 && enemyTimeThreshold <= 450){
        ...
        this.draw = function () {
            ...
            // debugger
            // if(enemyTimeThreshold >= 350 && enemyTimeThreshold < 700){
            //     debugger
            //     this.gameObject.height = 100
            //     this.gameObject.width = 100
            //     img = imageManager.get('trump1')
            // } else if(enemyTimeThreshold < 350 && enemyTimeThreshold >= -200){
            //     debugger
            //     this.gameObject.height = 100
            //     this.gameObject.width = 100
            //     img = imageManager.get('trump2')
            // }
            if (enemyTimeThreshold <= 450 && enemyTimeThreshold >= 400) {
                this.gameObject.height = 150
                this.gameObject.width = 150
                img = imageManager.get('hannity')
            }

            if(enemyTimeThreshold === -350){
                img = imageManager.get('carole')
            }
            // debugger
    ...
    var World = function () {
        ...
        var bullets = [];
        var lastEnemy = 0;
        // var enemyTimeThreshold = 2000;
        var update = function () {
            // debugger
            // if(enemyTimeThreshold === 350){ //change the enemy face at 350

            // }
            // if(enemyTimeThreshold >= 551){
            //     enemyTimeThreshold -= 50
            // }
            if (lastEnemy + enemyTimeThreshold < Date.now()) {
                ...
                if (enemyTimeThreshold === 450) { //enemyTimeThreshold >= 400
                    ...
                    trumpTimer += 1
                    enemyTimeThreshold += 0
                } else if (enemyTimeThreshold === -350) {
                    if (trumpTimer === 150) {
                        // debugger
                        enemyTimeThreshold = 1200
                        trumpTimer = 0
                    }
                    trumpTimer += 1
                } else {
        ...
        document.addEventListener('keyup', function (e) {
            var keyCode = (e.keyCode) ? e.keyCode : e.charCode
            if (KEY_CODES[keyCode] === 'space' && enemyTimeThreshold <= 450) {
                bullets.push(new Bullet(player.gameObject, new GameObject(0, -20, 0, 0)))
            }
            else {
                e.preventDefault();
